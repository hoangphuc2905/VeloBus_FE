...
const AccountInfo = () => {
  ...
  const handleFileChange = (event: ChangeEvent<HTMLInputElement>): void => {
    ...
    reader.onloadend = async () => {
      ...
      await updateUserInfo({ avatar: result }, dispatch);
      dispatch(updateUserInfoSuccess({ avatar: result }));
          ...
          <div className="info-item">
            ...
            {isEditing ? (
              ...
              <span className="info-value">
                {currentUser.dateOfBirth ? formatDate(currentUser.dateOfBirth) : "Chưa cập nhật"}
              </span>
            )}
          </div>
          <div className="info-item">
